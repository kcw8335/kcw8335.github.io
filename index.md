...
<section class="home-section library-section" id="library" data-paper-library>
  ...
  <div class="library-toolbar">
    ...
    <div class="library-tools">
      ...
      <div class="view-control" role="group" aria-label="논문 보기 방식">
        <button class="is-active" type="button" data-library-view="grid" aria-pressed="true">
          <span aria-hidden="true">▦</span>
          <span>그리드</span>
        </button>
        <button type="button" data-library-view="list" aria-pressed="false">
          <span aria-hidden="true">☷</span>
          <span>목록</span>
        </button>
      </div>
  ...
  <div class="library-result">
    <span role="status" aria-live="polite" aria-atomic="true"><strong data-result-count>{{ paper_count }}</strong>편 표시</span>
